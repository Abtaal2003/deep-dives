...
- **`requires-python`** — the minimum interpreter the project supports, for example `>=3.14`. uv refuses to resolve dependencies that need a newer Python than this allows, and it informs which versions are valid.
